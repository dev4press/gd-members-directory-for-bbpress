    ...
    <div class="d4p-setup-wrapper">
        <div class="d4p-update-info">
            ...
            <div class="d4p-install-confirm">
                <a class="button-primary" href="<?php echo esc_url( panel()->a()->panel_url( 'about' ) ); // phpcs:ignore WordPress.Security.EscapeOutput ?>&install"><?php esc_html_e( 'Click here to continue', 'gd-members-directory-for-bbpress' ); ?></a>
            </div>
        </div>
    </div>
</div>